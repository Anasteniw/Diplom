...
from backend.models import Shop, Category, Product, ProductParameter, ProductInfo, Parameter, Order, OrderItem, Contact, ConfirmEmailToken
        ...
        if {'first_name', 'last_name', 'email', 'password', 'company', 'position'}.issubset(request.data):
            try:
                ...
                if user_serializer.is_valid():
                    ...
                    new_user_registered.delay('Подтверждение регистрации', f'Токен для подтверждения {token.key}',
                                     user.email)
